// jshint ignore: start
// jscs: disable
ace.define("ace/mode/influxdb_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (require, exports, module) {
  "use strict";

  var oop = require("../lib/oop");
  var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;

  var InfluxdbHighlightRules = function () {
    var keywords = (
      "var"
    );
    ...
    var builtinFunctions = (
      "select|range|clear|sum|window|join|interpolate|union|filter|sort|rate|last|keys|cardinality|float"
    );
  ...
  oop.inherits(InfluxdbHighlightRules, TextHighlightRules);

  exports.InfluxdbHighlightRules = InfluxdbHighlightRules;
});

ace.define("ace/mode/influxdb_completions", ["require", "exports", "module", "ace/token_iterator", "ace/lib/lang"], function (require, exports, module) {
  "use strict";

  var lang = require("../lib/lang");

  var influxdbKeyWords = [
  ...
  var keyWordsCompletions = influxdbKeyWords.map(function (word) {
    return {
      caption: word,
      value: word,
      meta: "keyword",
  ...
  var functionsCompletions = influxdbFunctions.map(function (item) {
    return {
      caption: item.name,
      value: item.value,
  ...
  var InfluxdbCompletions = function () { };
  ...
  }).call(InfluxdbCompletions.prototype);

  exports.InfluxdbCompletions = InfluxdbCompletions;
});

ace.define("ace/mode/behaviour/influxdb", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour", "ace/mode/behaviour/cstyle", "ace/token_iterator"], function (require, exports, module) {
  "use strict";
  ...
  var InfluxdbBehaviour = function () {
  ...
  oop.inherits(InfluxdbBehaviour, CstyleBehaviour);

  exports.InfluxdbBehaviour = InfluxdbBehaviour;
});

ace.define("ace/mode/influxdb", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/influxdb_highlight_rules"], function (require, exports, module) {
  "use strict";

  var oop = require("../lib/oop");
  var TextMode = require("./text").Mode;
  var InfluxdbHighlightRules = require("./influxdb_highlight_rules").InfluxdbHighlightRules;
  var InfluxdbCompletions = require("./influxdb_completions").InfluxdbCompletions;
  var InfluxdbBehaviour = require("./behaviour/influxdb").InfluxdbBehaviour;

  var Mode = function () {
    this.HighlightRules = InfluxdbHighlightRules;
    this.$behaviour = new InfluxdbBehaviour();
    this.$completer = new InfluxdbCompletions();
